...
def _hrnet18(pretrained=True, progress=True, **kwargs):
    r"""HRNet-18 model
    """
    return _hrnet('hrnet18', pretrained, progress,
                   **kwargs)
...
def _hrnet32(pretrained=True, progress=True, **kwargs):
    r"""HRNet-32 model
    """
    return _hrnet('hrnet32', pretrained, progress,
                   **kwargs)
...
def _hrnet48(pretrained=True, progress=True, **kwargs):
    r"""HRNet-48 model
    """
    return _hrnet('hrnet48', pretrained, progress,
                   **kwargs)
...
def hrnet18(pretrained=True, progress=True, **kwargs):
    r"""HRNet-18 model
    """
    return HRNet_('hrnet18', pretrained)


def hrnet32(pretrained=True, progress=True, **kwargs):
    r"""HRNet-32 model
    """
    return HRNet_('hrnet32', pretrained)


def hrnet48(pretrained=True, progress=True, **kwargs):
    r"""HRNet-48 model
    """
    return HRNet_('hrnet48', pretrained)

class HRNet_(torch.nn.Module):
    def __init__(self, backbone, pretrained):
        super(HRNet_, self).__init__()
        if backbone == 'hrnet18':
            self.model = _hrnet18(pretrained=pretrained)
        elif backbone == 'hrnet32':
            self.model = _hrnet32(pretrained=pretrained)
        elif backbone == 'hrnet48':
            self.model = _hrnet48(pretrained=pretrained)
        else:
